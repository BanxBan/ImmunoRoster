...
export const patientSchema = z.object({
  ...
  place_of_birth: optionalSanitizedString,
  mother_name: optionalSanitizedString,
  father_name: optionalSanitizedString,
  birth_height: optionalSanitizedString,
  birth_weight: optionalSanitizedString,
  health_center: optionalSanitizedString,
  family_no: optionalSanitizedString,
...
export const animalBiteSchema = z.object({
  ...
  site_of_exposure: optionalSanitizedString,
  ...
  schedule_d14: z.string().regex(/^\d{4}-\d{2}-\d{2}$/).optional().nullable(),
  schedule_d21: z.string().regex(/^\d{4}-\d{2}-\d{2}$/).optional().nullable(),
