...
import { immunizationSchema, immunizationUpdateSchema, patientIdQuerySchema } from "./_lib/schemas.js";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === "POST") {
      const validated = validateRequest(req, res, { body: immunizationSchema });
      if (!validated) return;
